...
/* ── Dark section background (grid + glow orbs) ─────── */
  ...
  return (
    <section className="bg-brand-navy relative overflow-hidden py-24 lg:py-36">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <svg
          viewBox="0 0 600 600"
          className="h-[500px] w-[500px] opacity-[0.08] sm:h-[600px] sm:w-[600px]"
        >
          <motion.g
            animate={{ rotate: 360 }}
      ...
      <div className="relative mx-auto max-w-375 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <Location size={16} variant="Bold" className="text-[oklch(0.82_0.22_155)]" />
            Wilmington, Delaware
          </motion.div>
        </motion.div>
      </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            >
              ...
              keyword matching. Recruiters are overwhelmed. Great candidates fall
              through the cracks while companies struggle to fill critical roles.
            </motion.p>
          ...
          >
            ...
            <div className="space-y-3">
              {[
                { label: 'Applications received', pct: '100%', width: '100%', opacity: 1 },
                { label: 'Pass keyword filter', pct: '25%', width: '25%', opacity: 0.8 },
                { label: 'Reviewed by human', pct: '8%', width: '8%', opacity: 0.6 },
                { label: 'Actually qualified', pct: '???', width: '60%', opacity: 0.3 },
              ].map((row) => (
                <div key={row.label}>
      ...
      <div className="mx-auto max-w-375 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground mx-auto mt-4 max-w-xl text-xl">
            A smarter approach to connecting talent with opportunity — powered by
            AI that understands the full picture.
          </p>
        </motion.div>
      ...
      <div className="mx-auto max-w-375 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-2xl">
          ...
          <motion.div
            ...
            className="bg-border absolute top-0 bottom-0 left-[19px] w-px sm:left-[23px]"
          />
          ...
          <div className="bg-card rounded-2xl border p-8 sm:p-12">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button variant="outline" className="rounded-xl" asChild>
                <a href="https://www.nexprove.com/en" target="_blank" rel="noopener noreferrer">
                  <Global size={16} variant="Linear" />
                  Visit Nexprove
                </a>
              </Button>
              <Button variant="outline" className="rounded-xl" asChild>
                <a href="https://x.com/nexprove" target="_blank" rel="noopener noreferrer">
                  <XIcon />
                  Follow on X
                </a>
              </Button>
